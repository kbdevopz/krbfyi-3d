...
const experiences = [
  {
    ...
    company_name: "Cogwheel Tech",
    icon: cogwheel,
    iconBg: "#fff",
    date: "2025 - Present",
    points: [
      "Google Apps Script & Workspace — Building Apps Script automations, Looker dashboards, and Sheets/Drive integrations for enterprise data workflows",
      "Dynamics 365 & Programming — Developing and customizing D365 solutions within the John Deere dealership ecosystem (JDSMO, JDSO), building integrations and automations",
      "AI & Automation — Implementing conversational AI, predictive analytics, and RPA workflows (Power Automate, n8n) — up to 90% time savings for clients",
      "Full-Stack & Cloud — Delivering applications with React, Node.js, Python, Next.js, and cloud solutions across Azure, AWS, and GCP",
      "Data & BI — ETL pipelines, Power BI, Looker, BigQuery, and interactive analytics dashboards that transform raw data into actionable insight",
    ],
  },
  {
    ...
    points: [
      "Led a 23-person IT organization spanning development, data, networking, OT/SCADA, and enterprise IT at a 2,800-employee facility",
      "Oversaw technology operations, infrastructure, and digital transformation across production, quality, and supply chain",
      "Managed enterprise systems strategy, business intelligence, and operational technology across cross-functional teams",
      "Directed networking, security, and system administration supporting 24/7 manufacturing operations",
    ],
  },
  {
    ...
    points: [
      "Developed and maintained 11 Canvas apps on Power Platform with 100+ Power Automate flows serving 2,800+ users",
      "Co-developed production dashboards (Ignition) tracking KPIs across yield, throughput, labor efficiency, and quality metrics",
      "Dynamics 365 / Dataverse schema design, SharePoint administration, and enterprise integration workflows",
      "Statistical analysis in Jupyter notebooks (Python/Pandas) on yield performance, production efficiency, and workforce trends",
    ],
  },
  {
    ...
    points: [
      "Maintained SQL data pipelines (Azure SQL, Dataverse) feeding near-real-time analytics and operational reporting",
      "IT operations, troubleshooting, and systems support across enterprise infrastructure for a 2,800-employee facility",
      "Supported networking, Active Directory, and endpoint management in a 24/7 manufacturing environment",
      "Assisted with data analysis and reporting using Python, SQL, and Power BI",
    ],
  },
  {
    title: "Founder / Solutions Consultant",
    company_name: "1TechDigital (now Cogwheel Tech)",
    icon: onetechdigital,
    iconBg: "#fff",
    date: "Aug 2019 - Feb 2023",
    points: [
      "Digital innovation agency bridging software engineering and business strategy — connecting data, systems, and people through automation and analytics",
      "Data & BI — Designing data architectures, ETL pipelines, and interactive Power BI dashboards for real-time actionable insight",
      "AI Integration — Conversational AI, predictive analytics, computer-vision automation, and GPT-based solutions",
      "Automation & RPA — Power Automate, n8n, AI Builder — integrating systems and digitizing workflows",
      "Full-stack and low-code applications with React, Node.js, Python, Next.js, and Power Apps",
      "Cloud consulting on Azure, AWS, and Google Cloud — connecting CRMs, ERPs, and data sources into unified ecosystems",
    ],
  },
  {
    title: "Founder / Web Developer",
    company_name: "Coyote Web Solutions",
    icon: coyoteweb,
    iconBg: "#fff",
    date: "Sept 2000 - Aug 2019",
    points: [
      "Founded professional web and software development company in Vermillion, SD — helping businesses establish and grow their digital presence",
      "Full-stack development (PHP, .NET, JavaScript, MySQL) — from dynamic data-driven websites to enterprise-level business applications",
      "Custom CMS and e-commerce solutions — WordPress, Joomla, and Drupal integration, custom themes and plugins",
      "Database architecture, server administration, UX/UI design, and client consulting across multiple industries",
    ],
  },
];
